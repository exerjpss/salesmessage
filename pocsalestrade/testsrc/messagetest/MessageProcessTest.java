...
public class MessageProcessTest
{
    ...
    public void testCheckformat()
    {
        ...
        assertTrue("valid message, no data", mp.processMessage("0").getError() != ErrorRet.OK);
        assertTrue("valid message too long", mp.processMessage("0,1,3,4,5").getError() != ErrorRet.OK);
