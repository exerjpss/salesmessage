...
public class SalesRecordsTest
{
    ...
    int    totalp1qty = 0, totalp2qty = 0, totalp3qty = 0;
    ...
    public void assertioncheck ()
    {
        ...
        assertTrue("Sale no." + counter + " count " + totalqty, salesrec.getTotalSalesCount() == totalqty);
        ...
        assertTrue("Sale no." + counter + " count for [1] ", salesrec.getTotalSalesCount(1) == totalp1qty);
        assertTrue("Sale no." + counter + " value for [2] ", salesrec.getTotalSales(2) == totalp2sales);
        assertTrue("Sale no." + counter + " count for [2] ", salesrec.getTotalSalesCount(2) == totalp2qty);
        assertTrue("Sale no." + counter + " value for [3] ", salesrec.getTotalSales(3) == totalp3sales);
        assertTrue("Sale no." + counter + " count for [3] ", salesrec.getTotalSalesCount(3) == totalp3qty);
